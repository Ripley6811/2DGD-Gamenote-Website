...
Games.register(function(app, auth, database) {
  ...
  //Games.aggregateAsset('js','/packages/system/public/services/menus.js', {group:'footer', absolute:true, weight:-9999});
  //Games.aggregateAsset('js', 'test.js', {group: 'footer', weight: -1});
