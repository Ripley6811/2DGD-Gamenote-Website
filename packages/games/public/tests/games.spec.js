...
(function() {
  ...
  describe('MEAN controllers', function() {
    describe('GamesController', function() {
      ...
      it('$scope.update(true) should update a valid game', inject(function(Games) {
        ...
        /*
                ...
                EXPECTED: {"_id":"525a8422f6d0f87f0e407a33","title":"A Game about MEAN","to":"MEAN is great!"}
                GOT:      {"_id":"525a8422f6d0f87f0e407a33","title":"A Game about MEAN","to":"MEAN is great!","updated":[1383534772975]}
                */
      ...
      it('$scope.remove() should send a DELETE request with a valid gameId ' +
        'and remove the game from the scope', inject(function(Games) {
          ...
          // test after successful delete URL location games list
